# install-autostart.ps1 — make AI HQ start automatically when Windows logs in.
...
$sc.Description = 'AI HQ — Claude agent control panel'
$sc.Save()

Write-Output "Installed autostart shortcut: $lnk"
Write-Output "AI HQ will launch hidden on next login (port from config.json)."
